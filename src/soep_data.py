...
# Age categories
pl["long_age_cat"] = pd.cut(
    pl["age"], bins=[25, 45, 65, 85, np.inf], labels=[1, 2, 3, 4]
)
...
pl["college"] = np.where(
    pl["d11108"] == 3, 1, np.where(pl["d11108"].isin([1, 2]), 0, np.nan)
)
print(pl["ple0008"])
...
pl["short_age_cat"] = pd.cut(
    pl["age"], bins=[35, 45, 55, 65, 75, 85], labels=[1, 2, 3, 4, 5]
)

wealth_1_h = pl.loc[
    (pl["short_age_cat"] == 1) & (pl["health_cat"] == 1), "net_wealth0"
].median()

wealth_2_h = pl.loc[
    (pl["short_age_cat"] == 2) & (pl["health_cat"] == 1), "net_wealth0"
].median()
wealth_3_h = pl.loc[
    (pl["short_age_cat"] == 3) & (pl["health_cat"] == 1), "net_wealth0"
].median()
wealth_4_h = pl.loc[
    (pl["short_age_cat"] == 4) & (pl["health_cat"] == 1), "net_wealth0"
].median()
wealth_5_h = pl.loc[
    (pl["short_age_cat"] == 5) & (pl["health_cat"] == 1), "net_wealth0"
].median()
wealth_1_u = pl.loc[
    (pl["short_age_cat"] == 1) & (pl["health_cat"] == 0), "net_wealth0"
].median()
wealth_2_u = pl.loc[
    (pl["short_age_cat"] == 2) & (pl["health_cat"] == 0), "net_wealth0"
].median()
wealth_3_u = pl.loc[
    (pl["short_age_cat"] == 3) & (pl["health_cat"] == 0), "net_wealth0"
].median()
wealth_4_u = pl.loc[
    (pl["short_age_cat"] == 4) & (pl["health_cat"] == 0), "net_wealth0"
].median()
wealth_5_u = pl.loc[
    (pl["short_age_cat"] == 5) & (pl["health_cat"] == 0), "net_wealth0"
].median()
...
fig.write_image("../plots/wealthgaps.pdf", height=300, width=400)
...
fig.write_image("../plots/wealthgaps_pct.pdf", height=300, width=400)
