...
START_PARAMS = {
    ...
    "effort_cost": pd.DataFrame(
        {
            "low_bad": [0.628031290227532, 1.36593242946612, 1.64963812690034, 0.734873142494319],
            "low_good": [0.146075197675677, 0.55992411008533, 1.04795036000287, 1.60294886005945],
            "high_bad": [0.46921037985024, 0.996665589702672, 1.65388250352532, 1.08866246911941],
            "high_good": [0.091312997289004, 0.302477689083851, 0.739843441095022, 1.36582077051777],
        },
        index=[1, 12, 20, 31],
    ),
    "income_process": {
