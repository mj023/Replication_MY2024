...
fig.write_image("../plots/emp.pdf", height=300, width=400)
...
fig.write_image("../plots/inc.pdf", height=400, width=1000)
...
fig.write_image("../plots/wealth.pdf", height=300, width=400)
